        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div key={step.title} className="relative group">
              ...
              <div className="absolute inset-0 translate-x-2 translate-y-2 bg-main/90 rounded-lg z-0 transition group-hover:translate-x-3 group-hover:translate-y-3" />
              
              {/* Main card */}
              <Card className="relative z-10 bg-card shadow-lg text-center transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
